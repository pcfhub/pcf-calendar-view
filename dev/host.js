...
(function (root, factory) {
    ...
    var STRINGS = {
        CalendarView_Name: "Calendar View",
        ...
        CalendarView_Previous: "Previous",
        CalendarView_Next: "Next",
        CalendarView_Today: "Today",
        CalendarView_ViewLabel: "View",
        CalendarView_Loading: "Loading…",
        CalendarView_NoFilter: "This host cannot filter by date, so the calendar shows the {0} records the view loaded.",
        CalendarView_MoreAvailable: "{0} loaded — there are more in this range.",
        CalendarView_LoadMore: "Load more",
        CalendarView_EventCount: "{0} events",
        CalendarView_AddEvent: "Add an event on {0}",
        CalendarView_MoveEvent: "Move {0}",
        CalendarView_MoveEarlierDay: "A day earlier",
        CalendarView_MoveLaterDay: "A day later",
        CalendarView_MoveEarlierWeek: "A week earlier",
